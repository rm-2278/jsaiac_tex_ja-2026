...
for run in pinpad3_runs:
    # Use reward_mode as label
    if 'env.pinpad-easy.reward_mode' in run.config:
        label = run.config['env.pinpad-easy.reward_mode']
    elif 'reward_mode' in run.config:
