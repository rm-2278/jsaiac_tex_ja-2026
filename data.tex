...
\begin{figure*}[t]
  ...
  \caption{Atari 100kベンチマークにおける学習結果。上段が学習曲線、下段が400kステップ時点での方策画像から5フレーム間隔で抽出した6フレームを示す。Freewayでは単調な前進動作のみが繰り返され、複雑な方策は獲得されていない。}
