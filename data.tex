...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\columnwidth]{media/pinpad/reward-ratio-sweep/sweep-subgoal-temporal.png}
  \caption{報酬割り当て実験におけるサブゴール可視化の時間的変化。}
  \label{fig:reward-ratio-subgoal-temporal}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\columnwidth]{media/pinpad/reward-ratio-sweep/sweep-heatmap-temporal.png}
