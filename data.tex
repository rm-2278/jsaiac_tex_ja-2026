...
update-everyは8で実験を行った。





\subsection{時間的抽象化の調整}
...
これらの比率を変更することによって、学習がどう変化するかを確認した。限定的な向上が確認でき、報酬割り当て係数を変更することの有効性が示唆される。
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{media/pinpad/reward-ratio-sweep/sweep-subgoal-temporal.png}
