...
そこで、以下ではpinpadの報酬設計を元の実装から、末尾の一致度が上がるとスコアが与えられるように変更した（例えば、赤 $\rightarrow$ 赤緑に変化した場合、+2の報酬、赤緑 $\rightarrow$ 赤緑赤に変化した場合、-1の報酬が与えられる）。
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\columnwidth]{media/pinpad/reward-ratio-sweep/sweep-subgoal-temporal.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{media/pinpad/entropy-sweep/sweep-subgoal-temporal.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{media/pinpad/reward-design-sweep/sweep-subgoal-temporal.png}
